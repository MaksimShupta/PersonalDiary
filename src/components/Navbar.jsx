...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 flex justify-between items-center p-4 bg-black bg-opacity-30 backdrop-blur-md z-50">
      <div className="logo">
        <Link to="/" className="text-white text-2xl font-bold">DailyCanvas</Link>
      </div>
